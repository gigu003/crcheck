...
mp_beha_encr <- 
  c("8000/2", "8011/2", "8051/2", "8053/2", "8053/3", "8071/2", "8072/2", "8075/2", 
    "8078/2", "8083/2", "8084/2", "8100/3", "8103/3", "8121/2", "8123/2", "8124/2", 
    "8131/2", "8143/2", "8144/2", "8160/2", "8211/2", "8213/2", "8220/2", "8221/2", 
    "8248/3", "8250/2", "8251/2", "8252/2", "8253/2", "8255/2", "8260/2", "8262/2", 
    "8271/3", "8310/2", "8380/2", "8382/2", "8384/2", "8400/2", "8401/2", "8402/2", 
    "8403/2", "8409/2", "8410/2", "8440/1", "8441/2", "8443/3", "8444/3", "8480/2", 
    "8481/2", "8482/2", "8490/2", "8502/2", "8507/3", "8508/2", "8510/2", "8540/2", 
    "8542/2", "8543/2", "8550/2", "8560/2", "8570/2", "8573/2", "8590/3", "8721/2", 
    "8722/2", "8723/2", "8740/2", "8743/2", "8744/2", "8745/2", "8746/2", "8770/2", 
    "8771/2", "8772/2", "8825/3", "8832/1", "8940/2", "8941/2", "8983/3", "9013/3", 
    "9061/2", "9084/2")

morp_beha_dict <- substr(morp_o3_2$morp, 2, 7)
morp_beha_allowed <- list(
  icdo3_2 = morp_beha_dict,
  encr = mp_beha_encr
)
...
basi0 <- list(c(8000, 8170, 8160, 8970, 9120, 8800, 8010,
                8720, 9050, 9140, gen_morp(9590:9993)))
basi1 <- list(
  morp = list(8000, 8720, 9120, 9510, 9140),
  topo = list(gen_topo(0:809),
              gen_topo(c(440:449, 690, 693, 694)),
              gen_topo(445),
              gen_topo(692),
              gen_topo(440:449)))
basi2 <- list(
  morp = list(c(8000, 8800, 8850, 8890, 9120),
              8720, 8960, 8970,
              9510, 8170, 8153, 8160, 8240, 8453,
              c(9180, 9220), 9370, 9080, 9362, 9380, 9390,
              c(9391, 9392), 9395,
              c(9400, 9401, 9440, 9473),
              c(9450, 9451), 9470, 9530, 9751),
  topo = list(gen_topo(0:809),
              gen_topo(c(690, 693, 694)),
              gen_topo(640:649),
              gen_topo(220:229),
              gen_topo(692),
              gen_topo(220),
              gen_topo(254),
              gen_topo(c(221, 240, 249)),
              gen_topo(170:179),
              gen_topo(250:259),
              gen_topo(400:419),
              gen_topo(410),
              gen_topo(c(710:719, 751, 753)),
              gen_topo(753),
              gen_topo(710:720),
              gen_topo(c(715, 717)),
              gen_topo(c(715, 717, 720)),
              gen_topo(753),
              gen_topo(710:720),
              gen_topo(710:719),
              gen_topo(716),
              gen_topo(710:719),
              gen_topo(c(340:349, 410:419, 710:719))))
basi4 <- list(
  morp = list(8000, 8170, 9100, 9064, 9065,
              c(8240, 8241, 8158, 9500),
              c(8151, 8152, 8155), 8153, 8156, 8345,
              c(8271,8272), 8700, 9732, 9761),
  topo = list(gen_topo(c(180:209,230:259,560:569,610:619)),
              gen_topo(220),
              gen_topo(580:589),
              gen_topo(c(560:569,620:629)),
              gen_topo(620:629),
              gen_topo(0:809),
              gen_topo(250:259),
              gen_topo(c(160:169, 170:279, 250:259)),
              gen_topo(c(170, 250:259)),
              gen_topo(730:739),
              gen_topo(751),
              gen_topo(741), gen_topo(421), gen_topo(420)
  ))
basi5 <- list(
  c(8023, 9385, 9396, 9445, gen_morp(9475:9478), 9806,
    9807, 9812:9819, 9865, 9866, 9869,
    gen_morp(9875:9879), 9896, 9897, 9911, 9912,
    gen_morp(9965:9968), 9986)
)
basi7 <- list(
  c(8001, 8023, 9385, 9396, 9445, gen_morp(9475:9478),
    9806, 9807, 9812:9819, 9865, 9869, gen_morp(9876:9879),
    9896, 9897, 9911, 9912, gen_morp(9965:9968), 9986)
)
basi8 <- list(
  c(8023, 9385, 9396, 9400, 9401, 9445,
    9450, 9451, 9475:9478, 9806, 9807,
    gen_morp(9812:9819), 9865, 9866, 9869, 9875:9879,
    9896, 9897, 9911, 9912, 9965:9968, 9986)
)
morp_allowed_onbasi <- list(basi0=basi0,
                            basi1=basi1,
                            basi2=basi2,
                            basi4=basi4,
                            basi5=basi5,
                            basi7=basi7,
                            basi8=basi8)
morp_allowed_onsex <- list(
  male = c(8313, 8380:8384, 8441, 8460, 8471, 8482, 8600, 8670,
           8930, 8931, 8934, 8950, 8951, 9000, 9014, 9015, 9090),
  female = c(9061, 9062, 9063)
)
